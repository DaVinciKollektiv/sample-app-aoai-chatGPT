        ...
        try {
            ...
            if(!response?.ok){
                let errorChatMsg: ChatMessage = {
                    id: uuid(),
                    role: "error",
                    content: "There was an error generating a response. Chat history can't be saved at this time. If the problem persists, please contact the site administrator. Also Stefan!",
                    date: new Date().toISOString()
                }
                ...
                <Stack horizontal className={styles.chatRoot}>
                    <div className={styles.chatContainer}>
                        {!messages || messages.length < 1 ? (
                            <Stack className={styles.chatEmptyState}>
                                <img
                                    ...
                                    aria-hidden="true"
                                />
                                <h1 className={styles.chatEmptyStateTitle}>Hallo Peter, herzlich willkommen!</h1>
                                <h2 className={styles.chatEmptyStateSubtitle}>Die LuxxKI ist trainiert, um deine Fragen zu beantworten.</h2>
                            </Stack>
                        ) : (
                        ...
                        <Stack horizontal className={styles.chatInput}>
                            ...
                            <QuestionInput
                                clearOnSend
                                placeholder="Versuche eine neue Frage..."
                                disabled={isLoading}
                                onSend={(question, id) => {
